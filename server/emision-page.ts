    ...
    <main>
      ...
      <div class="shell">
        <section class="panel" aria-labelledby="form-title">
          ...
          ${error}
          <form method="post" action="/emision">
            <div class="field"><label for="monto_mxn">Monto (MXN)</label><input id="monto_mxn" name="monto_mxn" type="number" min="0" step="0.01" inputmode="decimal" required value="${fieldValue(state, "monto_mxn")}"></div>
            ...
            <p class="hint">La validación de elegibilidad y la oferta provienen del core.</p>
